package com.example.mymaple.config.auth;
import com.example.mymaple.dto.MemberRepository;
import com.example.mymaple.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private MemberVO saveOrUpdate(OAuthAttributes attributes) {
        MemberVO user = userRepository.findByEmail(attributes.getEmail())
